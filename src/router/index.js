...
import MaintenanceCalendar from "../features/maintenance-calendar/views/calendar-monthly-view.component.vue";
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/maintenance-calendar', component: MaintenanceCalendar, name: 'maintenance-calendar'},
